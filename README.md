...
* **API de Controle Financeiro Empresarial** – backend em Java (Spring Boot)
* **API de Controle de Turmas** – Java (Spring Boot)
* **API de Controle de Avaliações de Alunos** – Java (Spring Boot)
* **Sistema de Controle de Trens** - Interface Gráfica em QT - Linguagens: C++
